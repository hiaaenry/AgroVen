<script>
  let logo = "/imagens/logo2.png";
  let um = "/imagens/1.png";
  let dois = "/imagens/2.png";
  let tres = "/imagens/3.png";
</script>
...
<body>
  <div class="tabela">
    <div class="coluna">
      <div class="logo">
        <img src={logo} alt="AgroVen" width="100%" />
      </div>
      ...
      <form action="cadastrar.php" method="POST">
        <input
          ...
          required
        />
        <label id="labelEmail" for="email" /><br />
        ...
        <input
          ...
          required
        />
        <label id="labelSenha" for="senha" /><br />
        ...
        <input
          ...
          required
        />
        <label id="labelRepita" for="repita" /><br />
