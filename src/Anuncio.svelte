...
<body>
	...
	<div class="topnav">
		<div class="links">
			...
			<i href="#numero" class="fa fa-phone" aria-hidden="true" />
		</div>
		<div class="logo">
			<a href="#/">
				<img src={logo} alt="AgroVen" width="100px" />
			</a>
		</div>
	</div>
	...
	<div class="tabela">
		<form active="">
			...
			<div class="coluna">
				...
				<label for="number"
					>Ativar número de contato coorporativo.</label
				><br />
				<input type="checkbox" name="obs" id="local" />
				<label for="number"
					>Aceitar recebimento da retirada do produto no local!</label
				><br />
				<input type="checkbox" name="obs" id="localc" />
				<label for="number">Compartilhar localização</label><br />
				<br />
				<br />
				<button type="submit" class="publicar">Anunciar Produto</button>
			</div>
		</form>
	</div>
</body>
