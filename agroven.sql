...
CREATE TABLE AGR_COMPRA (
  ...
  COM_PRO_ID INT(11) NOT NULL, -- CHAVE ESTRAGEIRA/ADICIONAR FUNCIONALIDADE DEPOIS --
  COM_VEN_ID INT(11) NOT NULL,
  COM_CLI_ID INT(11) NOT NULL,
...
CREATE TABLE AGR_LISTA_DE_DESEJOS (
  ...
  LIS_PRO_ID INT(11) NOT NULL, -- CHAVE ESTRAGEIRA/ADICIONAR FUNCIONALIDADE DEPOIS --
